...
create table location (id bigint generated by default as identity (start with 1), name varchar(200), path varchar(300), version integer, fk_review bigint, primary key (id));
